...
public class Buku {
    ...
    private String judul, penerbit, penulis, loker;
    ...
    public Buku(Kategori kategori, String judul, String penerbit, String penulis, int tahun_terbit, int total, String loker){
    ...
    public Buku getById(int id){
        ...
        try{
            while(rs.next()){
                ...
                buku.setLoker(rs.getString("loker"));
            }
        } catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void save(){
        if(getById(idbuku).getIdbuku() == 0){
            String SQL = "INSERT INTO buku (judul, idkategori, penulis, penerbit, tahun_terbit, total, loker) VALUES("
                    +"  '" +this.judul+ "',"
