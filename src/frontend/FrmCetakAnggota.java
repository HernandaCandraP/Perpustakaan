...
public class FrmCetakAnggota extends javax.swing.JFrame {
String id;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cetak Data Anggota");
        jLabel1.setToolTipText("");
        jDesktopPane1.add(jLabel1);
        jLabel1.setBounds(110, 10, 470, 47);
    ...
    private void txtcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcetakActionPerformed
        // TODO add your handling code here:
         try {
          new FrmCetakAnggota().printComponents(null);
          TextTampilan.print();
    ...
    private void txtcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcariActionPerformed
        try{
            ResultSet rs = DBHelper.selectQuery("SELECT * from Anggota WHERE idanggota = '" +textId.getText()+ "'");
            Class.forName("com.mysql.jdbc.Driver").newInstance();

            if (rs.next()){
                TextTampilan.setText("              **** Perpustakaan SMPN 06 Malang ****"+
                    "\n==================================================" + "\n"
            ...
            JOptionPane.showMessageDialog(null,"Data Anggota tidak ditemukan"+ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCetakAnggota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
